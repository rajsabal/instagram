...
// console.log(posttimestamp);
  var posttime=new Date(Date.now()).getTime();     
  // var nowtime=new Date(Date.now()).getTime();
  
  if(posttimestamp!==null){  posttime=posttimestamp.toDate();
    
  }
  else console.log(postId);
    var date=new Date(Date.now());

    
    const d=posttime.getDate();
  const m=   posttime.getMonth()
  const y=posttime.getFullYear();
   var time="";
  //  console.log(posttimestamp.toDate());
  //  console.log(new Date(Date.now()).getTime());
   var timeDifference=date.getTime()-posttime;
